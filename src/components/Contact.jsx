					...
					<div className='max-w-[90%] w-full mx-auto py-8 grid grid-cols-2 gap-2 sm:gap-4'>
						...
						<div className='inline-flex justify-end items-center'>
							...
							<a
								...
								className='text-emerald-400 dark:text-teal-200 hover:text-gray-300 dark:hover:text-gray-400'
				...
				<div>
					...
					>
						<div class='w-full mx-auto'>
							...
							{errorMessage && (
								<div>
									<p className='text-slate-500 dark:text-rose-200 font-["Source_Code_pro"] font-medium tracking-tight text-xs'>
										{errorMessage}
									</p>
								</div>
							)}
