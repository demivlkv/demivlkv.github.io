  ...
  return (
    <footer className="footer py-8 text-xs sm:text-sm">
      <div className="flex flex-col justify-center items-center">
        <p className="flex justify-center items-center">Made with <Heart /> by <a href="https://github.com/demivlkv/demivlkv.github.io" target="_blank" className="ml-1 text-emerald-400 hover:text-gray-300">Demi</a>.</p>
        <p><span className="text-emerald-400">&copy;</span> 2023. All rights reserved.</p>
      </div>
