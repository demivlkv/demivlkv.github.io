    ...
    <ol className="flex flex-col md:flex-row relative border-l border-stone-200">
      <li className="mb-10 ml-4">
        ...
        <p className="flex flex-wrap flex-row justify-start items-center text-xs md:text-sm">
          ...
          <span className="mr-1 text-lg font-medium text-indigo-800">{title}</span>
          @ <span className="ml-1 text-lg font-medium text-slate-600">{company}</span>
          <span className="ml-4 my-1 text-sm font-normal text-stone-400">{duration}</span>
        </p>
