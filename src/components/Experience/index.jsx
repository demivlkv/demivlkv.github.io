...
const data = [
	{
		...
		details: () => (
			<ul>
				<li>
					{icon} Lead the development of front-end and full-stack solutions
					using TypeScript, React, Redux, NextJS, Node, MongoDB, and SCSS,
					producing optimized web experiences for modern web browsers
				</li>
				<li>
					{icon} Collaborate in an international 9-member in Agile team,
				...
				<li>
					{icon} Work with the design team to craft pixel-perfect UI/UX
					enhancements
				</li>
			</ul>
		),
	},
	{
		...
		details: () => (
			<ul>
				<li>
					{icon} Engineered and overhauled a dynamic front-end web application
					using JavaScript, Gatsby.js, GraphQL, Tailwind CSS, and Contentful,
